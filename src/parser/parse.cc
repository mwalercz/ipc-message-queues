// Generated by Bisonc++ V4.10.01 on Fri, 20 May 2016 00:20:31 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {276, 1}, // 1: message ->  query
     {276, 1}, // 2: message ->  tuple
     {277, 2}, // 3: query ->  query_head parts
     {278, 1}, // 4: query_head (OUTPUT) ->  OUTPUT
     {278, 1}, // 5: query_head (READ) ->  READ
     {279, 1}, // 6: parts ->  part
     {279, 3}, // 7: parts (COMA) ->  parts COMA part
     {280, 3}, // 8: part (INTEGER) ->  INTEGER DCOLON STAR
     {280, 3}, // 9: part (FLOAT) ->  FLOAT DCOLON STAR
     {280, 3}, // 10: part (STRING) ->  STRING DCOLON STAR
     {280, 4}, // 11: part (INTEGER) ->  INTEGER DCOLON SIGN integer_val
     {280, 4}, // 12: part (FLOAT) ->  FLOAT DCOLON SIGN float_val
     {280, 4}, // 13: part (STRING) ->  STRING DCOLON SIGN string_val
     {281, 1}, // 14: integer_val (INTEGER_VAL) ->  INTEGER_VAL
     {282, 1}, // 15: float_val (FLOAT_VAL) ->  FLOAT_VAL
     {283, 1}, // 16: string_val (STRING_VAL) ->  STRING_VAL
     {284, 2}, // 17: tuple ->  tuple_head tuple_elements
     {285, 1}, // 18: tuple_head (INPUT) ->  INPUT
     {286, 1}, // 19: tuple_elements ->  tuple_element
     {286, 3}, // 20: tuple_elements (COMA) ->  tuple_elements COMA tuple_element
     {287, 1}, // 21: tuple_element ->  float_val
     {287, 1}, // 22: tuple_element ->  integer_val
     {287, 1}, // 23: tuple_element ->  string_val
     {288, 1}, // 24: message_$ ->  message
};
...
{
    { { REQ_TOKEN}, {  9} },                  
    { {       286}, { 14} }, // tuple_elements
    { {       287}, { 15} }, // tuple_element 
    { {       282}, { 16} }, // float_val     
    { {       281}, { 17} }, // integer_val   
    { {       283}, { 18} }, // string_val    
    { {       263}, { 19} }, // FLOAT_VAL     
...
SMapVal s_symArr[] =
{
    ...
    SMapVal(276, "message"),
    SMapVal(277, "query"),
    SMapVal(278, "query_head"),
    SMapVal(279, "parts"),
    SMapVal(280, "part"),
    SMapVal(281, "integer_val"),
    SMapVal(282, "float_val"),
    SMapVal(283, "string_val"),
    SMapVal(284, "tuple"),
    SMapVal(285, "tuple_head"),
    SMapVal(286, "tuple_elements"),
    SMapVal(287, "tuple_element"),
    SMapVal(288, "message_$"),
};
...
#line 84 "parser.txt"
        {
         d_val__.get<Tag__::String>() = new std::string(d_scanner.matched());
         }
        break;
...
#line 91 "parser.txt"
        {
         d_val__.get<Tag__::Tuple>() = new Tuple(d_vsp__[0].data<Tag__::Tuple_elements>());
         }
        break;
...
#line 104 "parser.txt"
        {
         (d_val__.get<Tag__::Tuple_elements>()).push_back(*d_vsp__[0].data<Tag__::Element>());
