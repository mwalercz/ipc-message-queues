...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<Element::Comparison>
    {
        static Tag__ const tag = Tag__::Comparison;
    };

    template <>
    struct TagOf<Query>
    {
        static Tag__ const tag = Tag__::Query;
    };

    template <>
    struct TagOf<Element>
    {
        static Tag__ const tag = Tag__::Element;
    };
    ...
    struct TagOf<bool>
    {
        static Tag__ const tag = Tag__::Boolean;
    };

    template <>
    struct TypeOf<Tag__::Comparison>
    {
        typedef Element::Comparison type;
    };

    template <>
    struct TypeOf<Tag__::Query>
    {
        typedef Query type;
    };

    template <>
    struct TypeOf<Tag__::Element>
    {
