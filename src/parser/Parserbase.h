...
// $insert polymorphicSpecializations
    ...
    {
        static Tag__ const tag = Tag__::parts;
    };

    template <>
    struct TagOf<Tuple>
    {
        static Tag__ const tag = Tag__::tuple;
    };

    template <>
    struct TagOf<Element>
    {
        static Tag__ const tag = Tag__::tuple_element;
    };

    template <>
    struct TagOf<float>
    {
        static Tag__ const tag = Tag__::float_val;
    };

    template <>
    struct TagOf<int>
    {
        static Tag__ const tag = Tag__::integer_val;
    };

    template <>
    struct TagOf<std::string>
    {
        static Tag__ const tag = Tag__::string_val;
    };

    template <>
    struct TagOf<std::vector<Element>>
    {
        static Tag__ const tag = Tag__::tuple_elements;
    };

    template <>
    struct TypeOf<Tag__::parts>
    {
        typedef std::vector<std::string> type;
    };

    template <>
    struct TypeOf<Tag__::tuple>
    {
        typedef Tuple type;
    };

    template <>
    struct TypeOf<Tag__::tuple_element>
    {
        typedef Element type;
    };

    template <>
    struct TypeOf<Tag__::float_val>
    {
        typedef float type;
    };

    template <>
    struct TypeOf<Tag__::integer_val>
    {
        typedef int type;
    };

    template <>
    struct TypeOf<Tag__::string_val>
    {
        typedef std::string type;
    };

    template <>
    struct TypeOf<Tag__::tuple_elements>
    {
